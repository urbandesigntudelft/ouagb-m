...
description: "An analysis revealing the non-spaces and pop culture essence of Las Vegas"
categories: [Steven Izenour, Las Vegas, morphological layers, Learning from Las Vegas, morphology, Nolli map, non-spaces, the use of photographs, popular culture, Denise Scott Brown, traditional urban features, Robert Venturi, experience based, perception, composition]
date-format: "YYYY"
date: "1972"
fig-cap-location: bottom
---

![](../../images/las_vegas.jpg){#fig-las-vegas fig-align="center"}
...
A traditional analysis of Las Vegas would have made little sense since the city has few traditional urban features. That is; fig. 19.1 shows that in fact Las Vegas is built up from the same elements as any city, only in a different mix. This is also made clear by their re-use of the [Nolli map](roma_al_tempo_di_benedetto.qmd). A host of other new techniques is introduced, for instance in their visualisation of the importance of signs in Las Vegas and the use of photography. 