...
description: "An analysis of the landscape between Rotterdam and Den Haag"
categories: [Delft, analysis as basis for design, development, geomorphology, the Hague, landscape, analyses of large scale, morphological layers, Frits Palmboom, perspective drawings, rhetorics, Rotterdam, routes, visualisation, map based, scale, situation, context]
date-format: "YYYY"
date: "1990"
fig-cap-location: bottom
---

![Open spaces. From Landschap en Verstedelijking tussen Den Haag en Rotterdam, by F. Palmboom, 1990.](../../images/landschap_en_verstedelijking_2.jpg){#fig-landschap-en-verstedelijking fig-align="center"}
