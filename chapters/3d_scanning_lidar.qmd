...
![3D scan of Rocinha favela. From Favelas 4D, by MIT Senseable City Lab, 2021,  https://senseable.mit.edu/favelas/. Reproduced with permission.](../images/point_cloud.png){#fig-urban-taxonomy fig-align="center"}
...
2. Create your own point cloud. If data for your site already exists, go to step 3.
    ...
    Depending on your resources and project requirements, you can use different techniques to create a point cloud. 
      ...
      a. Photogrammetry (using a regular camera or smartphone)  
          ...
          Using a regular camera or smartphone, take several overlapping photos of your chosen object or area from different angles (the bigger the area, the more photographs you will need). You can then use [COLMAP](https://colmap.github.io/) to process these images into a point cloud.  
          
      b. iPhone with LiDAR sensor  
      
          Newer iPhones (iPhone 12 Pro or later) feature built-in LiDAR sensors, offering better accuracy than regular photos. This allows for detailed, real-time 3D scans. Apps like [3D Scanner App](https://3dscannerapp.com/) let you create 3D models directly on your phone, making it ideal for small-scale projects. 
...
3. Create a 3D model from your point cloud.
    ...
    a. Import the point cloud data into [CloudCompare](https://www.cloudcompare.org/). 
...
**Tasks** 
1. Obtain a map of your site from OpenStreetMap. 
