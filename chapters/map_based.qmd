...
nodes <- data.frame(
  ...
  label = c("The Concise Townscape", "Les Bastides", "The Memory of the City", 
            ...
            "Learning from Las Vegas", "Belvedere Bouwen: Vecht- en plassengebied"),
  ...
  url = c("../catalog/examples/concise_townscape.html", "../catalog/examples/les_bastides.html",
          ...
          "../catalog/examples/las_vegas.html", "../catalog/examples/belvedere_bouwen.html"),
...
edges <- data.frame(
  from = c(1, 1, 2, 4, 6, 6, 6, 8, 10, 14, 14, 22, 25, 25, 25, 25, 25, 26, 27, 27),
  to = c(12, 7, 10, 31, 32, 11, 12, 11, 16, 15, 24, 26, 2, 9, 10, 12, 13, 14, 33, 23)
