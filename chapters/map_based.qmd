...
nodes <- data.frame(
  id = 1:4,
  label = c("The Concise Townscape", "Les Bastides", "The Memory of the City", "Urban Taxonomy"),
  title = c("The Concise Townscape", "Les Bastides", "The Memory of the City", "Urban Taxonomy"),
  url = c("../catalog/examples/concise_townscape.html", "../catalog/examples/les_bastides.html",
          "../catalog/examples/memory_of_the_city.html", "../catalog/examples/urban_taxonomy.html"),
